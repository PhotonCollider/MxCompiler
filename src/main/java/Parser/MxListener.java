...
public interface MxListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code newVariableExpr}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterNewVariableExpr(MxParser.NewVariableExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code newVariableExpr}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitNewVariableExpr(MxParser.NewVariableExprContext ctx);
	/**
